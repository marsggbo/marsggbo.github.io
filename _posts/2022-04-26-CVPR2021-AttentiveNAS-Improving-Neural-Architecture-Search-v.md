...
![\begin{aligned} &\left\{\alpha_{i}^{*}\right\}=\underset{\alpha_{i} \in \mathcal{A}}{\arg \min } \mathcal{L}\left(W_{\alpha_{i}}^{*} ; \mathcal{D}^{v a l}\right), \\ &\text { s.t. } \operatorname{FLOPS}\left(\alpha_{i}\right)<\tau_{i}, \quad \forall i \end{aligned} \\](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/67841425.jpg)
...
* 公式(1)中的![\tau](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/8787bfea.jpg)表示候选网络的FLOPs，最优的![W^*](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/ee2aaf8f.jpg)简单理解就是 使得 不同FLOPs下(![\mathbb{E}_{\pi(\tau)}](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/c286af1c.jpg)) 所有子模型的loss期望 (![\mathbb{E}_{\pi(\alpha \mid \tau)}](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/06ce47be.jpg)) 最小的解。
* 公式(2)和(3)都是分别使用Monte Carlo采样做近似计算。比如 ![n](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/ce59f558.jpg)表示将整个搜索空间划分成![n](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/ce59f558.jpg)个FLOPs区间，![k](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/9d4a1163.jpg)表示每个FLOPs区间内每次采样更新的模型数量,![\gamma(\alpha)](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/c95c4a9f.jpg)是indicator函数，即如果模型结构![\alpha](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/b5edc039.jpg)满足指定条件，则![\gamma(\alpha)](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/c95c4a9f.jpg)等于1，反之为0。
...
上面数学公式中提到的![\gamma(\alpha)](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/c95c4a9f.jpg)是一个指示函数，其条件是![\alpha](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/b5edc039.jpg)是否属于 best或worst Pareto-front，分别记为BestUp-k和WorstUp-k
...
下图是AttentiveNAS基于第二种策略得到的实验结果， 其中![s0,s1](/assets/img/marsggbo/2022-04-26-CVPR2021-AttentiveNAS-Improving-Neural-Architecture-Search-v/39114852.jpg)分别表示在两个不同种子下跑的实验结果，ep30/ep360表示在训练30个epoch和360个epoch下的结果。可以看到预测的ACC和真实的ACC之间的相关系数Kendall tau（其范围是-1~1）还是比较大的。这表明预测器还是能有效预测出模型的ACC的。
