...
![execute_model() 内部六步](/assets/img/posts/20260706-vllm-v1-02-generate/diagram_execute_model.png)
...
> 扯一句题外话——我们团队在做 LLM 推理效率和 NAS 方向的研究，出了本[《动手学 AutoML：从 NAS 到大语言模型优化实战》](https://item.jd.com/14945889.html)。这篇聊的是 vllm 的推理计算流，书里更多是讲 AutoML/NAS 怎么用在大模型上，话题不完全重叠，但如果你对"怎么系统地优化大模型"这件事感兴趣，可以看看。
>
