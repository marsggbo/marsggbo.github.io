...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/680867d7.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/72794bf6.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/a199a205.jpg)

背后的原因：RoPE 给每个 token 分配一个绝对位置旋转角，位置变了旋转就变了；CoPE 是按语义边界索引、而非单个 token，相邻 token 可以共享索引，绝对偏移对它的影响更平滑：

![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/8b2459a3.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/977f19c4.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/376adc69.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/ec7d8b28.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/e1587437.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/e6c1fe8e.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/2fae1935.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/e9d42e6c.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/bfdbf3ab.jpg)
...
![](/assets/img/marsggbo/2026-04-26-KV-Cache-复用的第三条路FAST-2026-CacheSlide-是怎么解决-Agent-推理的位置漂移问题的/12767e3d.jpg)
