...
where ![w](/assets/img/marsggbo/2020-02-11-论文笔记系列AutoMLA-Survey-of-State-of-the-art-下/1c7a330b.jpg) is the weight factor defined as:

![w=\left\{\begin{array}{ll} {\alpha,} & {\text { if } L A T(m) \leq T} \\ {\beta,} & {\text { otherwise }} \end{array}\right. \\](/assets/img/marsggbo/2020-02-11-论文笔记系列AutoMLA-Survey-of-State-of-the-art-下/471e7d4b.jpg)
