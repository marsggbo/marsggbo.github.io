...
![连续 DLM 综合对比表（Table 2）](/assets/img/posts/20260526-flowtok/page_015.png)
...
![ELF 概念图：denoising 全程在连续空间，最后一步才离散化](/assets/img/posts/20260526-flowtok/page_002.png)
...
![ELF 训练（左）和推理（右）流程示意](/assets/img/posts/20260526-flowtok/page_003.png)
...
![x/v/ε-prediction 在不同 embedding 维度下的表现（Figure 10）](/assets/img/posts/20260526-flowtok/page_021.png)
...
![ELF 完整训练 pipeline（Figure 9）](/assets/img/posts/20260526-flowtok/page_016.png)
...
![Algorithm 1（ELF 训练）和 Algorithm 2（ELF 推理）](/assets/img/posts/20260526-flowtok/page_005.png)
...
![Algorithm 3：含 guidance 的完整训练算法](/assets/img/posts/20260526-flowtok/page_017.png)

Algorithm 5 是完整推理算法（含 guidance）：

![Algorithm 5：含 guidance 的完整推理算法](/assets/img/posts/20260526-flowtok/page_019.png)
...
![主实验结果：ELF vs MDLM/Duo/FLM/LangFlow（Figure 1）](/assets/img/posts/20260526-flowtok/page_001.png)
...
![Figure 6 (scaling) 和 Figure 7 (system-level 对比)](/assets/img/posts/20260526-flowtok/page_008.png)
...
![Figure 4（CFG 消融）+ Figure 5（embedding、decoding、sampler 消融）](/assets/img/posts/20260526-flowtok/page_007.png)
