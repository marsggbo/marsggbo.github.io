...
前瞻不是越大越好。固定 22-frame、7B 模型测试 \(L=0,2,4\) 时，每增加 2 帧要多付出 0.267 秒期望延迟；五套评测的平均 WER/CER 从 27.18 降到 25.91、再降到 24.66，cpWER/cpCER 从 35.88 降到 34.09、再降到 31.55。WER/CER 是不考虑说话人的词/字错误率，越低越好；cpWER/cpCER 则在此基础上还考察“话有没有挂到正确的说话人名下”，所以更能反映本文目标。
