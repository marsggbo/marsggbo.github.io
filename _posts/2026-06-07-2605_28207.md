...
> 📖 **新书推荐**：如果你对 MoE 部署优化、模型压缩、自动搜索这类话题感兴趣，欢迎看看我们刚出版的[《动手学 AutoML：从 NAS 到大语言模型优化实战》](https://item.jd.com/15384990.html)——系统讲透搜索空间设计、效率评估、LLM 压缩与微调等核心方法，配有完整可运行代码。京东搜索「动手学 AutoML」即可。
