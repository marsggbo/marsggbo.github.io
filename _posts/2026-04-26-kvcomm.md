---
layout: post
title: "KVCOMM：让多 Agent 系统的 KV Cache 真正“通起来”，TTFT 直接砍掉 7.8 倍"
date: 2026-04-26
tags: [LLM, Multi-Agent, KV Cache, 推理加速, 论文解读]
---
...
![不同 prefix 下同一 token 的 KV cache 偏移分析](/assets/img/posts/kvcomm/figure1_p2.png)
...
![KVCOMM 与现有 KV cache 复用方法的对比](/assets/img/posts/kvcomm/figure2_p3.png)
...
![KVCOMM 整体架构与运行流程](/assets/img/posts/kvcomm/figure3_p4.png)
...
![token embedding 距离与 KV cache 偏移的相关性](/assets/img/posts/kvcomm/figure4_p6.png)
...
![三种 cache 管理策略在不同任务和 agent 数下的精度对比](/assets/img/posts/kvcomm/table1_p8.png)
...
![TTFT 分解和不同输入长度下的加速比](/assets/img/posts/kvcomm/table2_p9.png)
