...
> 原文: <http://zhuanlan.zhihu.com/p/165335537>
...
$h_θ(x) = \frac{1}{1+e^{-θ^Tx}} \\$![J(θ)=\frac{1}{m} [\sum_{i=1}^{m} y^{(i)}( -logh_θ(x^{(i)})) + (1-y^{(i)})(-log(1-h_θ(x^{(i)})  )  ] + \frac{λ}{2m}\sum_{j=1}^{n}θ_j^2 \\](https://www.zhihu.com/equation?tex=J%28%CE%B8%29%3D%5Cfrac%7B1%7D%7Bm%7D+%5B%5Csum_%7Bi%3D1%7D%5E%7Bm%7D+y%5E%7B%28i%29%7D%28+-logh_%CE%B8%28x%5E%7B%28i%29%7D%29%29+%2B+%281-y%5E%7B%28i%29%7D%29%28-log%281-h_%CE%B8%28x%5E%7B%28i%29%7D%29++%29++%5D+%2B+%5Cfrac%7B%CE%BB%7D%7B2m%7D%5Csum_%7Bj%3D1%7D%5E%7Bn%7D%CE%B8_j%5E2+%5C%5C)
