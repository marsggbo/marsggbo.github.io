...
![](/assets/img/marsggbo/2019-01-03-双调排序Bitonic-Sort适合并行计算的排序算法/7ff46def.jpg)
...
![](/assets/img/marsggbo/2019-01-03-双调排序Bitonic-Sort适合并行计算的排序算法/2ba95975.jpg)

详细Bitonic merge图（本图只画到生成一个16长的双调序列，最后排序没有画出）：

![](/assets/img/marsggbo/2019-01-03-双调排序Bitonic-Sort适合并行计算的排序算法/05e06fb6.jpg)

最后再放一个8个元素排序的示意图[5]：

![](/assets/img/marsggbo/2019-01-03-双调排序Bitonic-Sort适合并行计算的排序算法/e70b66de.jpg)
...
* [1] CUDA(六). 从并行排序方法理解并行化思维——冒泡、归并、双调排序的GPU实现, [http://blog.csdn.net/abcjennifer/article/details/47110991](https://link.zhihu.com/?target=http%3A//blog.csdn.net/abcjennifer/article/details/47110991)
* [2] 并行计算】Bitonic Sort（双调排序）基础, [http://blog.csdn.net/jiange\\_zh/article/details/49533477](https://link.zhihu.com/?target=http%3A//blog.csdn.net/jiange/_zh/article/details/49533477)
* [3] 双调排序：从串行到并行，以及OpenCL上的实现, [http://blog.csdn.net/bryanlai0720/article/details/45094675](https://link.zhihu.com/?target=http%3A//blog.csdn.net/bryanlai0720/article/details/45094675)
* [4] n!=2^k的双调排序网络, [http://blog.csdn.net/ljiabin/article/details/8630627](https://link.zhihu.com/?target=http%3A//blog.csdn.net/ljiabin/article/details/8630627)
* [5] 分段双调排序实现, [http://blog.csdn.net/u014226072/article/details/56840243](https://link.zhihu.com/?target=http%3A//blog.csdn.net/u014226072/article/details/56840243)

---

原文：[https://blog.csdn.net/xbinworld/article/details/76408595](https://link.zhihu.com/?target=https%3A//blog.csdn.net/xbinworld/article/details/76408595)

## **MARSGGBO♥原创** **2019-1-3**