...
> **L**: 神经网络总层数  
>  ![S_l](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/8927cc94.jpg) ：l层单元个数（不包括bias unit）  
>  **k**:输出层个数
...
1. 利用前向传导公式(FP)计算![2,3……](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/eea4f7ca.jpg) 直到 ![{n_l}](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/bccacc91.jpg)层（**输出层**）的激活值。 计算过程如下：
...
首先需要知道的是BP算法是干嘛的？它是用来让神经网络自动更新权重![W](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/2a437219.jpg)的。 这里权重![W](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/2a437219.jpg)与之前线性回归权值更新形式上是一样：
...
> 注意![J(W,b;x^{(i)},y^{(i)})](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/65404923.jpg)表示的是单个样例的代价函数，而![J(W,b)](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/02bd7737.jpg)表示的是整体的代价函数。

所以接下来的工作就是求出![\frac{∂J(W,b;x,y)}{∂W_{ij^{(l)}}}](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/18c0ebf6.jpg)，求解这个需要用到微积分中的链式法则，即

![\begin{align*} \frac{∂J(W,b;x,y)}{∂W_{ij^{(l)}}} = \frac{∂J(W,b;x,y)}{∂a_{i^{(l)}}} \frac{∂a_{i^{(l)}}}{∂z_{i^{(l)}}} \frac{∂z_{i^{(l)}}}{∂w_{ij^{(l)}}}  = a_j^{(l)}δ_i^{(l+1)} \end{align*} \\](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/0d85766a.jpg)
...
所以这就是为什么老师在视频中没有乘以 ![f '(z_i^{(l)})](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/f8ada1b0.jpg) 的原因了，就是因为是线性的，求导后为1，直接省略了。

另外sigmoid函数表达式为![f(z)=\frac{1}{1+e^{-z}}](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/32c7d84c.jpg),很容易知道![f'(z)=\frac{-e^{-z}}{  (1+e^{-z}) ^2  }   = f(z)·(1-f(z))](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/2e2cb1eb.jpg)这也就解释了Coursera网站上讲义的公式是这样的了：

![\text { 4. Compute } \delta^{(L-1)}, \delta^{(L-2)}, \ldots, \delta^{(2)} \text { using } \delta^{(l)}=\left(\left(\Theta^{(l)}\right)^{T} \delta^{(l+1)}\right) \text { . * } a^{(l)} . *\left(1-a^{(l)}\right)](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/a8fe47d8.jpg)

所以现在总结一下**BP算法步骤：**

1. 进行前馈传导计算，利用前向传导公式，得到![L_2, L_3, \ldots](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/497489bd.jpg)直到输出层 ![\textstyle L_{n_l}](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/439ce968.jpg)的激活值。
2. 对输出层（第 ![\textstyle n_l](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/119af514.jpg)层），计算： ![\delta^{(n_l)}= - (y - a^{(n_l)}) \bullet f'(z^{(n_l)})](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/c9aa5465.jpg)
3. 对于 ![\textstyle l = n_l-1, n_l-2, n_l-3, \ldots, 2](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/9d8b95dc.jpg) 的各层，计算： ![\delta^{(l)} = \left((W^{(l)})^T \delta^{(l+1)}\right) \bullet f'(z^{(l)})](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/f081f5f7.jpg)
4. 计算最终需要的偏导数值：

![ \begin{align} \nabla_{W^{(l)}} J(W,b;x,y) &= \delta^{(l+1)} (a^{(l)})^T, \\ \nabla_{b^{(l)}} J(W,b;x,y) &= \delta^{(l+1)}. \end{align} \\](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/3e0e5f51.jpg)

使用**批量梯度下降一次迭**代过程：

1. 对于所有![\textstyle l](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/1ce37eb9.jpg)，令 ![\textstyle \Delta W^{(l)} := 0 ,  \textstyle \Delta b^{(l)} := 0](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/2adbd952.jpg) （设置为全零矩阵或全零向量）
2. 对于![\textstyle i = 1](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/e2f5c6d7.jpg) 到![\textstyle m](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/a75607c7.jpg) ， 使用反向传播算法计算![\textstyle \nabla_{W^{(l)}} J(W,b;x,y)](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/34179ead.jpg) 和![\textstyle \nabla_{b^{(l)}} J(W,b;x,y)](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/c7955753.jpg) 。 计算![\textstyle \Delta W^{(l)} := \Delta W^{(l)} + \nabla_{W^{(l)}} J(W,b;x,y)](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/de89b4c1.jpg) 。 计算![\textstyle \Delta b^{(l)} := \Delta b^{(l)} + \nabla_{b^{(l)}} J(W,b;x,y)](/assets/img/marsggbo/2020-07-30-Andrew-Ng机器学习课程笔记--week5-Network-Learning上/8e164286.jpg) 。
3. 更新权重参数：
