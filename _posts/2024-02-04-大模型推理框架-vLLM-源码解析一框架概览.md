---
layout: post
title: 大模型推理框架 vLLM 源码解析（一）：框架概览
date: '2024-02-04'
tags: [techniques]
category: techniques
grammar_cjkRuby: true
zhihu_url: http://zhuanlan.zhihu.com/p/681402162
related_posts: false
toc:
  sidebar: left
---

> 原文: <http://zhuanlan.zhihu.com/p/681402162>
...
3. 根据调度的结果，使用 tokenizer 将字符串转换成 prompt token id，然后喂给 model 进行计算得到 logits 预测结果

4. 根据 logits 预测结果和提前设置好的采样策略对结果进行采样得到新的 token id

5. 将采样结果保存到 output

![](/assets/img/marsggbo/2024-02-04-大模型推理框架-vLLM-源码解析一框架概览/6bb4843a.jpg)

inferencce pipeline

## **2. 整体核心模块**

![](/assets/img/marsggbo/2024-02-04-大模型推理框架-vLLM-源码解析一框架概览/2ab7416b.jpg)

上图给出了 vLLM 核心模块之间的结构关系。接下来我们从简单的模块（即输入、采样和输出）开始介绍，最后详细介绍 LLM 模块。

## **3. Sequence**

![](/assets/img/marsggbo/2024-02-04-大模型推理框架-vLLM-源码解析一框架概览/916c3153.jpg)
...
![](/assets/img/marsggbo/2024-02-04-大模型推理框架-vLLM-源码解析一框架概览/a78a0077.jpg)
...
![](/assets/img/marsggbo/2024-02-04-大模型推理框架-vLLM-源码解析一框架概览/9e786989.jpg)
